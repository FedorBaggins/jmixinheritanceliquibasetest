package com.company.jmixinheritanceliquibasetest.test_support;

import com.company.jmixinheritanceliquibasetest.JmixInheritanceliquibasetestApplication;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.jmixinheritanceliquibasetest.screen")
@ContextConfiguration(classes = {JmixInheritanceliquibasetestApplication.class, UiTestAssistConfiguration.class})
